...
let yourArray = [1, 2, true, "a", 5]; // Change this line
...
let myNestedArray = [
    // Only change code below this line
    ['unshift', false, 1, 2, 3, 'complex', ["deep", ["deeper", ["deepest", 2]]]],
...
function addFriend(userObj, friend) {
    // Only change code below this line
    const newArr = user.data.friends;
    newArr.push(friend);
    return user.data.friends = newArr;
    // Only change code above this line
}